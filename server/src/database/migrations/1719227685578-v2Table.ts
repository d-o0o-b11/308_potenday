...
export class V2Table1719227685578 implements MigrationInterface {
  name = 'V2Table1719227685578';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "common_question" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updateAt" TIMESTAMP NOT NULL DEFAULT now(), "deleteAt" TIMESTAMP, "url_id" integer NOT NULL, "question_1" boolean NOT NULL DEFAULT false, "question_2" boolean NOT NULL DEFAULT false, "question_3" boolean NOT NULL DEFAULT false, "question_4" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_a7ae3f81a75c88e200c626a3683" PRIMARY KEY ("url_id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "user_url" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updateAt" TIMESTAMP NOT NULL DEFAULT now(), "deleteAt" TIMESTAMP, "id" SERIAL NOT NULL, "url" character varying NOT NULL, "status" boolean NOT NULL DEFAULT true, CONSTRAINT "PK_8644584d3620c8fd95111270b75" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "user_balance" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updateAt" TIMESTAMP NOT NULL DEFAULT now(), "deleteAt" TIMESTAMP, "id" SERIAL NOT NULL, "user_id" integer NOT NULL, "balance_id" integer NOT NULL, "balance_type" character varying NOT NULL, CONSTRAINT "PK_f3edf5a1907e7b430421b9c2ddd" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "user_mbti" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updateAt" TIMESTAMP NOT NULL DEFAULT now(), "deleteAt" TIMESTAMP, "id" SERIAL NOT NULL, "user_id" integer NOT NULL, "mbti" character varying, "to_user_id" integer NOT NULL, CONSTRAINT "PK_8a54e7df9e49d9092e6759c020a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "user" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updateAt" TIMESTAMP NOT NULL DEFAULT now(), "deleteAt" TIMESTAMP, "id" SERIAL NOT NULL, "img_id" integer NOT NULL, "nickname" character varying NOT NULL, "onboarding" boolean NOT NULL DEFAULT false, "url_id" integer NOT NULL, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "user_adjective_expression" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updateAt" TIMESTAMP NOT NULL DEFAULT now(), "deleteAt" TIMESTAMP, "id" SERIAL NOT NULL, "user_id" integer NOT NULL, "adjective_expression_id" integer NOT NULL, CONSTRAINT "PK_8ddee23da43308f9fe5fd50a5d6" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "common_question" ADD CONSTRAINT "FK_a7ae3f81a75c88e200c626a3683" FOREIGN KEY ("url_id") REFERENCES "user_url"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user_adjective_expression" ADD CONSTRAINT "FK_4ef92c73750787b4fb0a87dfa32" FOREIGN KEY ("adjective_expression_id") REFERENCES "adjective_expression"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "common_question" DROP CONSTRAINT "FK_a7ae3f81a75c88e200c626a3683"`,
    );
